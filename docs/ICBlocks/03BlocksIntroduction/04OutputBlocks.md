...
| Type   | Description |  Example   |
| :---: | --- | --- |
| **Direct Control by Power Block** | Connect the Record Block to the Power Block's magnetic interface, long press the switch for 1s to start, press 🔈 to play the selected sound, press 🎙 to record sound, press ⚪ to switch between built-in sounds.   | ![](img/OutputBlocks20.gif) |
