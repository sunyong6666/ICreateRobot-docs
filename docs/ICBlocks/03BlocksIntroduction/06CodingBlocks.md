...
| **③** | English Name  | Describes the function or name of the block in the text for clarity | 
...
| :---: | :---: | :---: |
| **Motion Block** | ![](img/CodingBlocks21.png) |  Valid IDs: 545~639   |
| **Stop Block** | ![](img/CodingBlocks22.png) |  Valid IDs: 1360~1474   |
...
| **Name** | **Image** | **Block ID Range** |
| :---: | :---: | :---: |
| **Loop 1 Time Block** | ![](img/CodingBlocks06.png) |  Valid IDs: 3357~3307 |
| **Loop 2 Times Block** | ![](img/CodingBlocks07.png) |  Valid IDs: 3475~3405 |
| **Loop 3 Times Block** | ![](img/CodingBlocks08.png) |  Valid IDs: 3597~3507 |
| **Infinite Loop Block** | ![](img/CodingBlocks09.png) |  Valid IDs: 3684~3604 |
...
| **Name** | **Image** | **Block ID Range** |
| :---: | :---: | :---: |
| **Memory Module** | ![](img/CodingBlocks10.png) |  Valid IDs: 3793~3655 |
...
| **Name** | **Image** | **Block ID Range** |
| :---: | :---: | --- |
| **Start Motor Block** | ![](img/CodingBlocks19.png)<font style="color:#DF2A3F;background-color:#FBDE28;"></font> |  Valid IDs: 2790~2949 |
| **Stop Motor Block** | ![](img/CodingBlocks20.png)<font style="color:#DF2A3F;background-color:#FBDE28;"></font> |  Valid IDs: 2950~3119 |
...
| **Name** | **Image** | **Block ID Range** |
| :---: | :---: | :---: |
| **Turn On the Light Block** | ![](img/CodingBlocks23.png) |  Valid IDs: 2580~2674 |
| **Turn Off the Light Block** | ![](img/CodingBlocks24.png) |  Valid IDs: 2675~2789 |
...
| **Name** | **Image** | **Block ID Range** |
| :---: | :---: | :---: |
| **Smile Block** | ![](img/CodingBlocks04.png) |  Valid IDs: 1475~1574 |
| **Angry Block** | ![](img/CodingBlocks02.png) |  Valid IDs: 1575~1654 |
| **Sad Block** | ![](img/CodingBlocks01.png) |  Valid IDs: 1655~1744 |
| **Happy Block** | ![](img/CodingBlocks03.png) |  Valid IDs:1745~1899 |
| **Cry Block** | ![](img/CodingBlocks05.png) |  Valid IDs: 1900~2009 |
...
| **Name** | **Image** | **Block ID Range** |
| :---: | :---: | :---: |
| **Play Recording Block** | ![](img/CodingBlocks29.png) |  Valid IDs: 2490~2579 |
| **Phone Ring Block** | ![](img/CodingBlocks27.png) |  Valid IDs: 2400~1489 |
| **Car Whistle Block** | ![](img/CodingBlocks30.png) |  Valid IDs: 2300~2399 |
| **Fireengine Siren Block** | ![](img/CodingBlocks26.png) |  Valid IDs: 2100~2199 |
| **Police Car Siren Block** | ![](img/CodingBlocks25.png) |  Valid IDs: 2010~2099 |
| **Train Whistle Block** | ![](img/CodingBlocks28.png) |  Valid IDs: 2200~2299 |
...
| **Name** | **Image** | **Block ID Range** |
| :---: | :---: | :---: |
| **One Step Forward Block** | ![](img/CodingBlocks11.png) |  Valid IDs:  1010~1099 |
| **Two Steps Forward Block** | ![](img/CodingBlocks12.png) |  Valid IDs: 3120~3295 |
| **Forward Until Block** | ![](img/CodingBlocks13.png) |  Valid IDs:  1275~1359 |
| **Step Back Block** | ![](img/CodingBlocks14.png) |  Valid IDs: 850~1009 |
| **Turn Left 90° Block** | ![](img/CodingBlocks15.png) |  Valid IDs: 640~729 |
| **Turn Left Until Block** | ![](img/CodingBlocks16.png) |  Valid IDs: 1100~1189 |
| **Turn Right 90° Block** | ![](img/CodingBlocks17.png) |  Valid IDs: 730~849 |
| **Turn Right Until Block** | ![](img/CodingBlocks18.png) |  Valid IDs: 1190~1274 |
